...
public class GridDemoPage extends TemplatePage {
    ...
    @Inject
    @ConfigProperty(name = "app.title", defaultValue = "JettraEEFlux Example")
    private String appTitle;

    public GridDemoPage() {
        try {
            this.appTitle = ConfigProvider.getConfig().getOptionalValue("app.title", String.class).orElse("JettraEEFlux Example");
        } catch (Exception e) {
            this.appTitle = "JettraEEFlux Example";
        }
    }
