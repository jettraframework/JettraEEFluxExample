...
public class PersonCrudPage extends com.flux.example.pages.template.TemplatePage {
    ...
    private PersonModelConverter getConverter() {
        if (converter == null) {
            converter = new PersonModelConverter();
        }
        return converter;
    }
    ...
    private void saveForm(HttpExchange exchange, Map<String, String> params) {
        ...
        if (hasErrors) {
            ...
            getPersonService().save(getConverter().toRecord(personForm));
            try {
    ...
    private void deleteItem(HttpExchange exchange, Map<String, String> params) {
        deleteRecord(exchange, params);
    }
    ...
    protected Widget buildCenter(HttpExchange exchange, Map<String, String> params, String currentTheme) {
        ...
        List<Person> rawPersons = getPersonService().findAll();
        List<PersonModel> persons = new ArrayList<>();
        if (rawPersons != null) {
            persons = rawPersons.stream()
                .map(getConverter()::toModel)
