...
public class PersonPage extends TemplatePage {
    ...
    private Properties getMsg() {
        if (msg == null) {
            msg = new Properties();
            try (var is = getClass().getResourceAsStream("/messages_es.properties")) {
                if (is != null) msg.load(is);
    ...
    public String getTitle() {
        return getMsg().getProperty("personpage.title", "Gestión de Personas");
    }
...
//        IO.println("Conversor to Record"+ personModelConverter.toRecord(personModel).toString());
    ...
    protected Widget buildCenter(HttpExchange exchange, Map<String, String> params, String currentTheme) {
       ...
       // Muestra como guardar y recuperar objetos de la sesion
        ...
        // --- Center Content ---
        return Column.of(
                Header.of(2, getMsg().getProperty("personpage.title", "Gestión de Personas"))
